...
SECRET_KEY = 'django-insecure-mm)#9ap*u(w6x+z$abl-klopa*grn^l6*^tpgr1@&k)!@_+4^e'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'bunyodbekpirnazarov425@gmail.com'
EMAIL_HOST_PASSWORD = 'mjagbmsipgblkmzf'
